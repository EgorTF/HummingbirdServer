                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "蜂鸟权限系统API接口文档");
                        ...
                        c.IncludeXmlComments(string.Format("{0}/bin/Hummingbird.WebAPI.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                        c.IncludeXmlComments(string.Format("{0}/bin/Hummingbird.Model.xml", System.AppDomain.CurrentDomain.BaseDirectory));
